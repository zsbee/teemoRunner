...
import com.Zsombor.Fuszenecker.Teemo.Objects.ObjectConstants;
import com.Zsombor.Fuszenecker.Teemo.Objects.TrapSprite;
...
*/
   ...
   /*     spearHit = Gdx.audio.newSound(Gdx.files.internal("spearHit.mp3"));
        trapHit = Gdx.audio.newSound(Gdx.files.internal("spearHit.mp3"));
*/
    }
  ...
  //              spearHit.play();
    ...
    private void deadTeemo()
    {
        Gdx.app.log("trap","kill");
    //    trapHit.play();
        int randomPos = (int) Math.floor(Math.random()*(deadSounds.size()));
        deadSounds.get(randomPos).play();
    }
